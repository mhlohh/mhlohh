...
# ("gap",)                     -> vertical space
ROWS = [
    ("kv", "Now", "Btech CSE (AI/ML) @ Mentor Engineering Collge"),
    ("kev", "Prev", "Intern @Litmus7"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, JavaScript, TypeScript"),
    ("kv", "Backend", "Fast API", "REST API", "SQLite3", "pg-admin"),
    ("kv", "AI / ML", "Google AI SDK, AI ADK, OpenAI"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Build Low Image filter In C Manipulating pixels"),
    ("bul", "Build and Architect Fullstack AI Businuess Insight System."),
    ("bul", "Build Mobile First Biomechanical Kinematic Tracker"),
    ("bul", "scaling 16-bit PCM samples. in C to modify the volume" ),
    ("bul", "Intern @Litmus7 on first year"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">@mhlohh: ~$ neofetch</text>')
